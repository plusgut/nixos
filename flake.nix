{
  ...
  outputs = { self, nixpkgs, nixos-hardware, kak-auto-pairs, kak-wakatime
    , kak-active-window, nix-vscode-extensions, strictly-vscode-extension, helix
    , ... }@attrs:
    let
      common = ({ pkgs, ... }: {
        nix = {
        ...
        networking.wireless.networks.BlackRain.extraConfig =
        ...
        environment.systemPackages =
          map (flake: flake.packages.${pkgs.system}.default)
